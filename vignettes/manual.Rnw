...
Once installed, you need to load the package into the current session to access the functions and help pages. With the function \texttt{library}, you perform this step:
